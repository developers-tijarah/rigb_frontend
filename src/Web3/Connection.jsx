...
const contractAddress = '0x427316bf265Fd660B66c397861f0185d2821b636';
...
export const statble_Coins = {
  ...
  97: {
    USDT: '0x4169e624bB7200C00E55Ed526929bfE78B5348A6',
    USDC: '0xA6C81867f9Fa6b0e7f1D5941E41c91B6DBd19BeD',
  },
};
export const statble_Coins_decimal = {
  1: 6,
  56: 18,
  97: 18,
};
...
export async function Allow(user, tokenAddress, walletProvider) {
  try {
    ...
    const data = await contract.methods.allowance(user, contractAddress).call();
    return data;
  } catch (error) {
    console.log(error);
  }
...
export async function Approve(user, tokenAddress, walletProvider) {
  try {
    const web3 = new Web3(walletProvider);
    const contract = new web3.eth.Contract(tokendbi, tokenAddress);
    const data = await contract.methods
      .approve(contractAddress, 115792089237316195423570985008687907853269984665640564039457584007913129639935n)
      .send({ from: user, gasPrice:"10000000000" });
    return data;
  } catch (error) {
    console.log(error);
  }
